    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">conso Energy</a>
                <div class="dropdown-menu bg-light m-0">
                    <a href="{{ route('energyconso.index') }}" class="dropdown-item">List</a>
                    <a href="{{ route('energyconso.create') }}" class="dropdown-item">Add</a>
