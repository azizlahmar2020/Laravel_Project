    ...
    <div class="container mt-5 custom-container">
        ...
        <form action="{{ route('Logement.update', $logement->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="address" name="address" value="{{ old('address', $logement->address) }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="superficie" name="superficie" value="{{ old('superficie', $logement->superficie) }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="nbr_habitant" name="nbr_habitant" value="{{ old('nbr_habitant', $logement->nbr_habitant) }}" min="1" required>
            </div>
